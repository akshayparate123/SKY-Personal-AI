...
train_df["agent_1"] = dataset_training["agent_1"]
train_df["agent_2"] = dataset_training["agent_2"]
valid_df["agent_1"] = dataset_validation["agent_1"]
valid_df["agent_2"] = dataset_validation["agent_2"]
...
def main():
    ...
    for epoch in range(epochs):
        ...
        X_test = dataset_testing["agent_1"]
        y_test = dataset_testing["agent_2"]
