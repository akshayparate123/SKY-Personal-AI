...
dataset = pd.read_csv("../Data/Summary/Dialog Summarization/CSV/train.csv")
# dataset = load_dataset("Ateeqq/news-title-generator")
X_train, X_test, y_train, y_test = train_test_split(dataset["dialogue"],dataset["topic"], test_size=0.1, random_state=42)
# X_test, X_valid, y_test, y_valid = train_test_split(X_test,y_test, test_size=0.5, random_state=42)
train_df = pd.DataFrame()
valid_df = pd.DataFrame()
train_df["dialogue"] = X_train
train_df["topic"] = y_train
valid_df["dialogue"] = X_test
valid_df["topic"] = y_test
...
train_dataset = TextDataset(
    ...
    labels=train_df['topic'].to_numpy(),
    tokenizer=tokenizer,
...
val_dataset = TextDataset(
    ...
    labels=valid_df['topic'].to_numpy(),
    tokenizer=tokenizer,
    ip_max_len = ip_max_len,
    op_max_len = op_max_len
)
